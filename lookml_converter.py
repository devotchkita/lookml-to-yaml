...
st.markdown(
    """
    <div style='text-align: center; color: #595959; font-family: "Roboto Mono", monospace; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; padding: 2rem 0;'>
...
dimension: marketing_channel {
  ...
  description: "Channel where the activity was run"
  hidden: no
  type: string
